                ...
                playerTabs.forEach { a ->
                    ...
                    if (tabName.isNotBlank()) {
                        try {
                            ...
                            Log.e("KawanFilmProvider", "Error loading tab $tabName: ${e.message}")
                        }
                    }
                }
            }
            ...
            playerTabs.forEach { a ->
                ...
                if (href.isNotBlank() && !href.startsWith("#") && href != "javascript:void(0)" && href != data) {
                    try {
                        ...
                        Log.e("KawanFilmProvider", "Error loading tab link: ${e.message}")
                    }
                }
            }
        } catch (e: Exception) {
            Log.e("KawanFilmProvider", "Error in loadLinks: ${e.message}")
        }
        return found
    }
}
