...
class Bioskopgratis21Top : StreamWishExtractor() {
    override var name = "Bioskopgratis21Top"
    override var mainUrl = "https://bioskopgratis21.top"
}
...
class Ransplaytualan : StreamWishExtractor() {
    override var name = "Ransplaytualan"
    override var mainUrl = "https://ransplay-tualan.com"
}

class WebKawanfilm21Co : StreamWishExtractor() {
    override var name = "WebKawanfilm21Co"
    override var mainUrl = "https://web.kawanfilm21.co"
}

class TambakbetVip : StreamWishExtractor() {
    override var name = "TambakbetVip"
    override var mainUrl = "https://tambakbet.vip"
}

class StyleMixlinkTop : StreamWishExtractor() {
    override var name = "StyleMixlinkTop"
    override var mainUrl = "https://style.mixlink.top"
}

class TrustText : StreamWishExtractor() {
    override var name = "TrustText"
    override var mainUrl = "https://trust.text.com"
}

class AccountsLivechat : StreamWishExtractor() {
    override var name = "AccountsLivechat"
    override var mainUrl = "https://accounts.livechat.com"
}

class CdnMixlinkTop : StreamWishExtractor() {
    override var name = "CdnMixlinkTop"
    override var mainUrl = "https://cdn.mixlink.top"
}

class AixassetS3Apsoutheast1Amazonaws : StreamWishExtractor() {
    override var name = "AixassetS3Apsoutheast1Amazonaws"
    override var mainUrl = "https://aix-asset.s3.ap-southeast-1.amazonaws.com"
}

class IYtimg : StreamWishExtractor() {
    override var name = "IYtimg"
...
class RPMVid : StreamWishExtractor() {
    override var name = "RPMVid"
    override var mainUrl = "https://RPMVid"
}

class STRP2P : StreamWishExtractor() {
    override var name = "STRP2P"
    override var mainUrl = "https://STRP2P"
}

class Abyssplayer : StreamWishExtractor() {
    override var name = "Abyssplayer"
    override var mainUrl = "https://Abyssplayer"
}

class Morencius : StreamWishExtractor() {
    override var name = "Morencius"
    override var mainUrl = "https://Morencius"
}

class EarnVids : StreamWishExtractor() {
    override var name = "EarnVids"
    override var mainUrl = "https://EarnVids"
}

class RPMShare : StreamWishExtractor() {
    override var name = "RPMShare"
    override var mainUrl = "https://RPMShare"
}
