...
class AnimixplayProvider : MainAPI() {
    ...
    private suspend fun scrapeList(pageUrl: String): List<SearchResponse> {
        ...
        return doc.select(".listupd .bsx, .listupd .bs, .bsx, .bs, article.bs, .item, article, .swiper-slide, .card, div.card, article.item, .movie-item, .post-item, div.module-item, div.ml-item, .box-item, .post, .entry, .film-poster-ahref").mapNotNull {
