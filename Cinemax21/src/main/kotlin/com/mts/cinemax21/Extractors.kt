...
class D2Ww6N6ZilcrhvCloudfrontNet : StreamWishExtractor() {
    ...
    override val mainUrl = "https://d2ww6n6zilcrhv.cloudfront.net"
}

class Max389ProNet : StreamWishExtractor() {
    override val name = "Max389ProNet"
    override val mainUrl = "https://max389pro.net"
}

class MaxhokiMonster : StreamWishExtractor() {
    override val name = "MaxhokiMonster"
