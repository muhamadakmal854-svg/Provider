                ...
                playerTabs.forEach { a ->
                    ...
                    if (tabName.isNotBlank()) {
                        try {
                            ...
                            Log.e("Terbit21Provider", "Error loading tab $tabName: ${e.message}")
                        }
                    }
                }
            }
            ...
            playerTabs.forEach { a ->
                ...
                if (href.isNotBlank() && !href.startsWith("#") && href != "javascript:void(0)" && href != data) {
                    try {
                        ...
                        Log.e("Terbit21Provider", "Error loading tab link: ${e.message}")
                    }
                }
            }
        } catch (e: Exception) {
            Log.e("Terbit21Provider", "Error in loadLinks: ${e.message}")
        }
        return found
    }
}
