...
class IndoxxiProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "tv" to "FILM SERIES",
        "category/coming-soon" to "REKOMENDASI LAIN INDOXXI - IDLIX",
        "" to "UPDATE TERBARU INDOXXI - IDLIX"
    )
    ...
    override suspend fun loadLinks(
        ...
        targets.forEach { (embedUrl, serverLabel) ->
            ...
            try {
                ...
                android.util.Log.e("Indoxxi", "Extractor failed for $cleanUrl: ${e.message}")
            }
        }
