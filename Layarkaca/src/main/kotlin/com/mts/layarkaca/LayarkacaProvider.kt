...
class LayarkacaProvider : BaseFixProvider() {
    ...
    override val mainPage = mainPageOf(
        ...
        "nontondrama?page=top-series-today" to "SERIES UNGGULAN",
        ...
        "maraton-drakor" to "Maraton Drakor",
        ...
        "" to "Daftar Lengkap Film Terbaru"
    )
    ...
    private suspend fun scrapeList(pageUrl: String): List<SearchResponse> {
        ...
        return doc.select("article, .slider, li.slider, .sliders, .slider-wrapper, div.slider-wrapper, .widget, div.widget, .container, div.container, .card, div.card, article.item, .item, .movie-item, .post-item, div.module-item, div.ml-item, .box-item, .post, .entry, .film-poster-ahref").mapNotNull {
