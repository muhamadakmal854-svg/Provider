...
class Emas5000Gold : StreamWishExtractor() {
    override var name = "Emas5000Gold"
    override var mainUrl = "https://emas5000.gold"
}

class BrightMoonlightcodexUs : StreamWishExtractor() {
    override var name = "BrightMoonlightcodexUs"
    override var mainUrl = "https://bright.moonlightcodex.us"
}

class FilesSitestaticNet : StreamWishExtractor() {
    override var name = "FilesSitestaticNet"
    override var mainUrl = "https://files.sitestatic.net"
}

class QqsawerBiz : StreamWishExtractor() {
    override var name = "QqsawerBiz"
    override var mainUrl = "https://qqsawer.biz"
}
...
class Server7KucingNet : StreamWishExtractor() {
    override var name = "Server7KucingNet"
    override var mainUrl = "https://7kucing.net"
}

class Vip69MecdnXyz : StreamWishExtractor() {
    override var name = "Vip69MecdnXyz"
    override var mainUrl = "https://vip69.mecdn.xyz"
}
