...
class BunnycdnSe : StreamWishExtractor() {
    override var name = "BunnycdnSe"
    override var mainUrl = "https://bunnycdn.se"
}

class JodwishCom : StreamWishExtractor() {
    override var name = "JodwishCom"
    override var mainUrl = "https://jodwish.com"
}

class VidhidevipCom : EarnVids() {
...
class D1F05Vr3Sjsuy7CloudfrontNet : StreamWishExtractor() {
    override var name = "D1F05Vr3Sjsuy7CloudfrontNet"
    override var mainUrl = "https://d1f05vr3sjsuy7.cloudfront.net"
}

class RyderjetCom : StreamWishExtractor() {
    override var name = "RyderjetCom"
...
class FlaswishCom : StreamWishExtractor() {
    override var name = "FlaswishCom"
    override var mainUrl = "https://flaswish.com"
}

class Mp4UploadCom : Mp4Upload() {
    override var name = "Mp4UploadCom"
...
class SblonaCom : StreamWishExtractor() {
    override var name = "SblonaCom"
    override var mainUrl = "https://sblona.com"
}

class FembedCom : Fembed() {
    override var name = "FembedCom"
    override var mainUrl = "https://fembed.com"
}
...
class VipdownloaderxyzBlogspotCom : ExtractorApi() {
    override var name = "VipdownloaderxyzBlogspotCom"
    override var mainUrl = "https://vipdownloaderxyz.blogspot.com"
    override val requiresReferer = true
    private val googleVideoReferer = "https://youtube.googleapis.com/"
    private val rpcId = "WcwnYd"
...
class EmturbovidCom : StreamWishExtractor() {
    override var name = "EmturbovidCom"
    override var mainUrl = "https://emturbovid.com"
}

class AnimekhorUpnsLive : StreamWishExtractor() {
    override var name = "AnimekhorUpnsLive"
    override var mainUrl = "https://animekhor.upns.live"
}

class ListeamedNet : Vidguardto() {
    override var name = "ListeamedNet"
    override var mainUrl = "https://listeamed.net"
}

class TurbovidhlsCom : StreamWishExtractor() {
    override var name = "TurbovidhlsCom"
    override var mainUrl = "https://turbovidhls.com"
}

class BysekozeCom : StreamWishExtractor() {
    override var name = "BysekozeCom"
    override var mainUrl = "https://bysekoze.com"
}

class PlayAbyssplayerCom : ExtractorApi() {
    override var name = "PlayAbyssplayerCom"
...
class RubyvidhubCom : StreamRuby() {
    override var name = "RubyvidhubCom"
