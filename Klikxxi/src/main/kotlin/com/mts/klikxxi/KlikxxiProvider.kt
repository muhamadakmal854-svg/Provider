...
class KlikxxiProvider : MainAPI() {
    ...
    override var mainUrl        = "https://ahgary.com"
    ...
    private suspend fun scrapeList(pageUrl: String): List<SearchResponse> {
        ...
        val primaryCards = doc.select("article.item, .item, article, .listupd .bsx, .listupd .bs, .bsx, .bs, article.bs, .animpost, article.animpost, .animepost, article.animepost, .film-poster, .item-anime, .epbox, .out-thumb, .milist, .post-item, .hentry")
