        ...
        if (isSeries) {
            ...
            if (episodes.isEmpty()) {
                try {
                    ...
                    Log.e("KlikxxiProvider", "REST episode fetch error: ${e.message}")
                }
            }
        ...
        try {
            ...
            serverTabLinks.distinct().take(6).forEach { tabUrl ->
                try {
                    ...
                    Log.e("KlikxxiProvider", "Server tab error [$tabUrl]: ${e.message}")
                }
            }
                ...
                doc.select("ul.muvipro-player-tabs a[href^='#p'], ul.nav-tabs a[href^='#p']").forEach { a ->
                    ...
                    if (tabName.isNotBlank()) {
                        try {
                            ...
                            Log.e("KlikxxiProvider", "AJAX tab error: ${e.message}")
                        }
                    }
                }
            }
            ...
            Log.e("KlikxxiProvider", "loadLinks error: ${e.message}")
        }
        return found
    }
}
