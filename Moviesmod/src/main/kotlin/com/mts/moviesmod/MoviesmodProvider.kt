...
class MoviesmodProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "tv-series" to "TV Series Terbaru",
    ...
    private suspend fun scrapeList(pageUrl: String): List<SearchResponse> {
        ...
        return doc.select("article, .latestPost, article.latestPost, .excerpt, article.excerpt, .card, div.card, article.item, .item, .movie-item, .post-item, div.module-item, div.ml-item, .box-item, .post, .entry, .film-poster-ahref").mapNotNull {
