        ...
        if (isSeries) {
            ...
            if (episodes.isEmpty()) {
                try {
                    ...
                    Log.e("Pusatfilm21Provider", "REST episode fetch error: ${e.message}")
                }
            }
        ...
        try {
            ...
            serverTabLinks.distinct().take(6).forEach { tabUrl ->
                try {
                    ...
                    Log.e("Pusatfilm21Provider", "Server tab error [$tabUrl]: ${e.message}")
                }
            }
                ...
                doc.select("ul.muvipro-player-tabs a[href^='#p'], ul.nav-tabs a[href^='#p']").forEach { a ->
                    ...
                    if (tabName.isNotBlank()) {
                        try {
                            ...
                            Log.e("Pusatfilm21Provider", "AJAX tab error: ${e.message}")
                        }
                    }
                }
            }
            ...
            Log.e("Pusatfilm21Provider", "loadLinks error: ${e.message}")
        }
        return found
    }
}
