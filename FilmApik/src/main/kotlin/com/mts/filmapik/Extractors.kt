...
open class EfekStream : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        runCatching {
            ...
            // 2. Extract sources from jwplayer playlist
            // Example: {'label':'720p','type':'video/mp4','file':'https://s2.efek.stream/stream/720/ErEgrAYhIezE4xD/__001'}
            ...
            // 3. Fallback: Parse direct download page (&down=load)
            ...
            // 4. Fallback: Search for any direct m3u8 or mp4 URLs
